...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 text-slate-300 pt-20 pb-5 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-10 md:mb-5 pb-10 md:pb-16 border-b border-slate-700/50">
          <div className="lg:col-span-4">
            <Link href="/" className="inline-block mb-6">
              <h3 className="text-gradient-bright text-3xl font-bold tracking-tight">AllTooly</h3>
            </Link>
              ...
              <ul className="space-y-4">
                <li>
                  <Link href="/categories/text-analysis" className="hover:text-indigo-300 transition-colors group flex items-center">
                    <i className="fas fa-angle-right text-xs mr-2 text-white group-hover:text-indigo-400 transition-all"></i>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <p className="text-slate-400 text-sm">© {new Date().getFullYear()} AllTooly. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
