  ...
  return (
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 text-slate-300 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-10 md:mb-12 pb-10 md:pb-16 border-b border-slate-700/50">
          <div className="lg:col-span-4">
            ...
            <div className="mt-6 md:mt-10 flex flex-wrap gap-x-8 gap-y-3">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <p className="text-slate-400">© {new Date().getFullYear()} AllTooly. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
